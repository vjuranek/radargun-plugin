...
public class NodeTest {
    ...
    public void testJavaOptsOnly() {
        ...
        Map<String, String> envVars = new HashMap<>();
        envVars.put("infinispan_server1_address", "172.12.0.1");
        Node node = new Node("test_hostname", null, null, javaProps, envVars, null, null, true);
        assertNotNull(node.getAllJavaOpts());
        assertEquals(
    ...
    public void testJvmOptsOnly() {
        Map<String, String> envVars = new HashMap<>();
        envVars.put("infinispan_server1_address", "172.12.0.1");
        Node node = new Node("test_hostname", null, "-server -Xms8g -Xmx8g -XX:+UseLargePages", null, envVars, null, null, true);
        assertNotNull(node.getAllJavaOpts());
    ...
    public void testHostname() {
        Node node1  = new Node("test_name", "test_fqdn", null, null, null, null, null, true);
        assertEquals("test_fqdn", node1.getHostname());
        Node node2  = new Node("test_name", null, null, null, null, null, null, true);
